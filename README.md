...
* [Работа с HTTP API](#002)
* [Работа с WebView](#003)
* [Работа с навигацией (Navigation API)](#004)
* [Работа с БД Интеграции (Storage API)](#005)
* [Работа с БД Терминала (Inventory API)](#006)
* [Логирование данных (Logging API)](#007)
...
Перед использованием http api, необходимо явно указать необходимость использования данного функционала в скрипте:  
...
`Navigation api` используется для работы с `WebView`.
